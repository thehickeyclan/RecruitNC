/**
 * Create Women's Blue Ultimate Club Duals 2025 singlet — sold out, $75, public store listing.
 *
 * Usage: npx tsx scripts/seed-womens-blue-ultimate-club-duals-2025-singlet.ts
 */
...
const SLUG = "womens-blue-ultimate-club-duals-2025-singlet"
const SOURCE_IMAGE = "public/images/store/womens-blue-ultimate-club-duals-2025-singlet-source.png"
const PRICE = 75
const SKU_PREFIX = "NCU-UC25WB-SING"
...
async function main() {
  ...
  const productRow = {
    name: "Women's Blue Ultimate Club Duals 2025 Singlet",
    description:
      "Official NC United women's blue singlet from Ultimate Club Duals 2025. Takedown competition cut — navy body with star pattern, North Carolina script chest graphic, patriotic V-stripe, and light blue N★C leg detail. This season is complete — listing kept for reference; all sizes are sold out.",
  ...
  const variantRows = NHSCA_HUB_GEAR_SIZES.map((size) => ({
    ...
    color: "Blue",
    size,
    sku: `${SKU_PREFIX}-BLU-${size.replace(/\s+/g, "")}`,
    stock_quantity: 0,
  }))
