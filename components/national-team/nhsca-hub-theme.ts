...
export const hubMainClass =
  "container mx-auto px-4 sm:px-6 py-6 md:py-10 max-w-4xl space-y-6 pb-[max(1.5rem,env(safe-area-inset-bottom))]"
...
export const hubPanelHeaderClass =
  "border-b border-white/10 bg-white/[0.04] px-4 py-3.5 sm:px-5 sm:py-4 md:px-6 md:py-5"
...
export const hubInfoBannerClass =
  "rounded-2xl border border-[#CBAF5D]/40 bg-[#CBAF5D]/15 px-4 py-3 sm:px-5 sm:py-4 text-sm text-white/95 leading-relaxed"
