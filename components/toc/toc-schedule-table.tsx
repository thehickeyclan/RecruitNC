...
const FRIDAY = [
  ...
  { time: "5:30 PM", activity: "Doors open" },
    ...
    <section id="schedule" className="py-16 md:py-20 bg-[#f4f5f7] scroll-mt-20">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <p className="text-center text-muted-foreground mb-10 max-w-2xl mx-auto">
          Two mats Friday and Saturday through placement bouts — then one mat under the lights for championship finals.
          Built like a show, not another all-day grind.
        </p>
        <div className="grid md:grid-cols-2 gap-6">
          <DayTable title="Friday · September 4" subtitle="Opening round & first look at the field" rows={FRIDAY} />
