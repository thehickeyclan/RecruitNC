...
export function TocCollegeAttendees({ colleges }: Props) {
  ...
  return (
    <div className="mt-12 pt-10 border-t border-white/12">
      <p className="text-[11px] font-medium tracking-[0.28em] uppercase text-white/45 mb-2">
        Recruiting fair
      </p>
      <h3 className={`text-2xl md:text-3xl text-white ${tocDisplayClass()}`}>
        Confirmed college programs
      </h3>
      <p className="mt-2 text-sm text-white/60 max-w-xl">
        Programs listed below have reserved a table at the Tournament of Champions college fair.
      </p>
