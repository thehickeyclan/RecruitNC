...
export const TOC_CADEN_PERRY_WARRIOR_SCHOLARSHIP = {
  ...
  award: "The inaugural award provides $1,300 in wrestling support for one North Carolina wrestler whose response to genuine adversity reflects that same warrior spirit.",
...
export const TOC_OFFICIAL_TEE = {
  ...
  alt: "Official navy Tournament of Champions tee with the event wordmark on the front and One State, One Champion on the back",
  width: 1537,
  height: 1023,
  items: [
    "Created as the official apparel of the inaugural NC United Tournament of Champions.",
    "Front: Tournament of Champions wordmark in white and gold.",
    "Tee back: One State. One Champion. with NC United in gold.",
...
export const TOC_OFFICIAL_APPAREL = [
  {
    ...
    caption: "Front & back",
    src: "/images/toc/toc-2026-official-tee.png",
    alt: "Official navy Tournament of Champions tee — event wordmark on the front and One State, One Champion on the back",
    width: 1537,
    height: 1023,
  },
  {
...
export const TOC_SCHEDULE = {
  ...
  friday: {
    ...
    rows: [
      ...
      { time: "4:30 PM", activity: "Doors open to the public · ticket sales open" },
      { time: "5:00–5:15 PM", activity: "Coaches meeting — officials address the coaches in the warm-up room" },
      {
        time: "5:30 PM",
...
export const TOC_FOUNDING_PARTNERS = {
  ...
  partners: [
    ...
    },
    {
      ...
      newsHref: "/news/nc-united-wrestling-guild-premier-partner",
    },
    {
      name: "Cama Meal",
...
export const TOC_SECTION_NAV_GROUPS = [
  {
    ...
    links: [
      ...
      { href: "#giving-hour", label: "Giving Hour" },
