...
export function buildTocAthleteInviteMessage(payload: {
  ...
  const smsBody = `${firstName} — you're invited to the NC United Tournament of Champions (${payload.weightClass} lbs). ${TOC_EVENT_DATES_DISPLAY}, Apex. Learn more: ${learnMoreUrl} Confirm: ${confirmUrl}`
