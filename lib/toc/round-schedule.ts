 ...
 * in two scenarios; this is the ten-weight one, 184 having been dropped on 5 September when the
 * field did not fill.
 */
...
export const SATURDAY_ROUNDS: readonly ScheduledRound[] = [
  ...
  { time: "6:45 PM", label: "Most Outstanding Wrestler & Match of Champions", kind: "finals", detail: "Presented last." },
]
