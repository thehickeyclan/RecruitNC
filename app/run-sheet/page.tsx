...
const FRIDAY: Row[] = [
  ...
  { a: "5:15 PM", what: "All athletes to the warm-up area", detail: "Staged for the walk-in. Line them up in weight order now rather than after the ceremony — they can then walk in, stand, and go straight out to the mats without being re-sorted.", kind: "beat" },
  { a: "5:30 PM", what: "Athletes walk into the gym", kind: "beat" },
  { a: "5:35 PM", what: "Welcome and prayer — Jason Gore", kind: "beat" },
  { a: "5:40 PM", what: "National anthem — to be named", kind: "beat" },
  { a: "5:45 PM", what: "Athletes form two lines in weight order", detail: "Roughly 44 a line with a full field. This is the slowest part of the ceremony and needs a marshal on each line, briefed beforehand.", kind: "beat" },
  { a: "5:55 PM", what: "Out through opposite doors, line up on each mat", kind: "beat" },
...
const NOTES = [
  ...
  "The opening runs on thirty minutes and the tight part is not the speeches — it is moving eighty-odd wrestlers twice. Sorting them into weight order in the warm-up area at 5:15, before they walk in, means the post-ceremony move is a split into two lines rather than a re-sort, and saves five to eight minutes of milling about.",
