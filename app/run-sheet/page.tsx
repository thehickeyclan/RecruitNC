...
const FRIDAY: Row[] = [
  ...
  { a: "4:15 – 5:30 PM", what: "Mats open for warm-ups", detail: "Rolling — wrestlers come on as they clear the scale, rather than everyone waiting for the last weigh-in. Seventy-five minutes of mat availability; a wrestler weighing in late still gets half an hour.", kind: "beat" },
  ...
  { a: "5:30 PM", what: "Wrestlers clear the mats · table workers report", kind: "prep" },
...
const SATURDAY: Row[] = [
  ...
  { a: "7:30 – 9:15 AM", b: "7:00 – 8:45 AM", what: "Athletes in · mats open for warm-ups", detail: "An hour and three quarters, ending fifteen minutes before the first bout so nobody goes cold waiting.", kind: "beat" },
  { a: "8:30 AM", b: "8:00 AM", what: "Doors open to spectators", kind: "prep" },
  { a: "9:15 AM", b: "8:45 AM", what: "Wrestlers clear the mats", kind: "prep" },
...
const NOTES = [
  ...
  "Warm-ups run alongside weigh-ins rather than after them. Waiting for the last wrestler off the scale would leave fifteen minutes for eighty athletes; opening the mats as they clear gives everyone at least half an hour, and the ones who weigh early get far more.",
