  ...
  const handleRawTextParse = () => {
    ...
    const dedupNote =
      matchCountBeforeDedup > matchCountAfterDedup
        ? ` (${matchCountBeforeDedup - matchCountAfterDedup} duplicate bouts removed)`
        : ""
    setParseResult({
      success: true,
