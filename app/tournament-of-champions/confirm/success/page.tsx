...
export const metadata: Metadata = {
  ...
  description: "Complete Tournament of Champions registration payment.",
  ...
  return (
    <section className="min-h-[60vh] bg-[#0B1D3A] text-white flex flex-col">
      ...
      <div className="container mx-auto w-full px-4 sm:px-6 py-16 sm:py-24 max-w-3xl flex-1 flex flex-col justify-center text-center">
        <p className="text-[#CC0000] text-sm tracking-[0.2em] uppercase font-semibold mb-4">Payment required</p>
        <TocVarsityHeading as="h1" className="text-white text-4xl sm:text-5xl md:text-6xl mb-4">
          Almost there.
        </TocVarsityHeading>
        <p className={`text-2xl sm:text-3xl text-white/90 mb-6 ${tocDisplayClass()}`}>Finish checkout to lock the spot.</p>
