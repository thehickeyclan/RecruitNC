      ...
      <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
        ...
        <Card id="event-details">
          ...
          <CardContent className="space-y-4 text-gray-700">
            ...
            <p>
              <strong>Dates:</strong> May 23–25, 2026 (Memorial Day Weekend)
            </p>
            ...
            <p>
              <strong>Boys High School:</strong> 208 teams
            </p>
        ...
        <Card className="border-[#D3B574]/50 bg-gradient-to-br from-[#002147]/5 to-[#003366]/5">
          ...
          <CardContent className="space-y-3 text-gray-700">
            ...
            <Button asChild className="bg-[#003366] hover:bg-[#002147] text-white">
