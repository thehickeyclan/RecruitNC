...
export default function NCHSAAOverview() {
  ...
  const classificationData = {
    "8A": {
      ...
      color: "from-[#002147] to-[#001a38]",
      bgColor: "from-[#002147]/5 to-[#002147]/10",
    ...
    <div className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6 md:mb-8">
          <Card className="border-2 border-[#002147] bg-gradient-to-r from-[#002147] to-[#001a38]">
          ...
          <Card className="lg:col-span-2 border-2 border-[#002147]">
            ...
            <CardContent className="p-4 md:p-6">
              <div className="space-y-3 md:space-y-4">
                <p className="text-[#002147] leading-relaxed text-sm md:text-base">
                ...
                <div className="grid md:grid-cols-2 gap-3 md:gap-4 mt-4 md:mt-6">
                  <div className="bg-[#CBAF5D]/10 p-3 md:p-4 rounded-lg border border-[#CBAF5D]/30">
                    <h4 className="font-semibold text-[#002147] mb-2 text-sm md:text-base">Tournament Format</h4>
                    <ul className="text-xs md:text-sm space-y-1 text-[#002147]/80">
                  ...
                  <div className="bg-[#002147]/5 p-3 md:p-4 rounded-lg border border-[#002147]/20">
                    <h4 className="font-semibold text-[#002147] mb-2 text-sm md:text-base">Qualification</h4>
                    <ul className="text-xs md:text-sm space-y-1 text-[#002147]/80">
              ...
              <CardContent className="p-4">
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge className="bg-[#002147]">8 (1A-8A)</Badge>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-slate-600">Weight Classes</span>
                    <Badge className="bg-[#002147]">14 per class</Badge>
                  </div>
                  <div className="flex justify-between items-center">
              ...
              <CardContent className="p-4">
                <div className="space-y-3 text-sm">
                  <div className="bg-yellow-50 p-3 rounded border border-yellow-200">
                    <div className="font-semibold text-[#002147]">🏆 State Champions</div>
                    <div className="text-slate-600">Multiple NCHSAA State Champions</div>
                  </div>
                  <div className="bg-blue-50 p-3 rounded border border-blue-200">
                    <div className="font-semibold text-[#002147]">🥈 Place Winners</div>
                    <div className="text-slate-600">Numerous top-6 finishers</div>
                  </div>
                  <div className="bg-slate-50 p-3 rounded border border-slate-200">
                    <div className="font-semibold text-[#002147]">📈 Consistency</div>
        ...
        <Card className="mb-6 md:mb-8">
          <CardHeader className="p-4 md:p-6">
            <CardTitle className="text-[#002147] flex items-center gap-2 text-lg md:text-xl">
          ...
          <CardContent className="p-4 md:p-6">
            <div className="mb-4 md:mb-6 p-3 md:p-4 bg-gradient-to-r from-[#002147]/5 to-[#002147]/10 rounded-lg border border-[#002147]/20">
              <h3 className="font-semibold text-[#002147] mb-2 text-sm md:text-base">About the 8A System</h3>
              <p className="text-[#002147] text-xs md:text-sm leading-relaxed">
                  ...
                  <CollapsibleContent className="mt-2">
                    <Card className={`border-2 ${data.borderColor}`}>
                      <CardContent className="p-3 md:p-4">
                        <p className="text-[#002147] text-xs md:text-sm mb-3 md:mb-4 leading-relaxed">{data.description}</p>
                          ...
                          if (regions.length > 0) {
                            return (
                              <div className="mb-4 md:mb-6 space-y-3 md:space-y-4">
                                <h4 className="font-semibold text-[#002147] text-xs md:text-sm mb-2 md:mb-3 flex items-center gap-2">
                                ...
                                {regions.map((regionData) => {
                                  ...
                                  return (
                                    ...
                                    >
                                      <CollapsibleTrigger asChild>
                                        <Button
                                          ...
                                          className={`w-full justify-between p-2 md:p-3 h-auto bg-gradient-to-r ${
                                            isEast ? "from-[#B31B1B]/5 to-[#B31B1B]/10" : "from-[#002147]/5 to-[#002147]/10"
                                          } border-2 ${
                                            isEast ? "border-[#B31B1B]/20" : "border-[#002147]/20"
                                          } hover:shadow-md transition-all`}
                                        >
                                          <div className="flex items-center gap-2 md:gap-3 flex-1 min-w-0">
                                            <Badge
                                              className={`bg-gradient-to-r ${
                                                isEast ? "from-[#B31B1B] to-[#8f1616]" : "from-[#002147] to-[#001a38]"
                                      ...
                                      <CollapsibleContent className="mt-2">
                                        <Card className={`border-2 ${isEast ? "border-[#B31B1B]/20" : "border-[#002147]/20"}`}>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <div className="mb-6 p-4 bg-gradient-to-r from-[#B31B1B]/5 to-[#CBAF5D]/5 rounded-lg border border-[#B31B1B]/20">
              <h3 className="font-semibold text-[#002147] mb-2">Key Changes for 2025-26</h3>
              <p className="text-[#002147] text-sm leading-relaxed">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <Card className="border-2 border-[#002147]/20">
                <CardHeader className="bg-[#002147]/5">
                  <CardTitle className="text-[#002147] text-lg">Regional Structure</CardTitle>
                </CardHeader>
                <CardContent className="p-4">
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      <Badge className="bg-[#002147] text-white">East Regional</Badge>
                      <span className="text-[#002147]/70 text-sm">Top 4 advance</span>
                    </div>
                    <div className="flex items-center gap-3">
                      <Badge className="bg-[#002147] text-white">West Regional</Badge>
                      <span className="text-[#002147]/70 text-sm">Top 4 advance</span>
                    </div>
                    <div className="mt-4 p-3 bg-[#CBAF5D]/10 rounded border border-[#CBAF5D]/30">
                      <div className="font-semibold text-[#002147] text-sm">Total State Qualifiers</div>
                      <div className="text-[#002147]/70 text-sm">8 wrestlers per weight class</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 border-[#CBAF5D]/20">
                <CardHeader className="bg-[#CBAF5D]/10">
                  <CardTitle className="text-[#002147] text-lg">Championship Format</CardTitle>
                </CardHeader>
                <CardContent className="p-4">
                  <div className="space-y-4">
                    <div>
                      <h4 className="font-semibold text-[#002147] mb-2">Boys Wrestling</h4>
                      <ul className="text-sm space-y-1 text-[#002147]/80">
                        <li>• 1A & 2A: Combined championship</li>
                        <li>• 3A-8A: Individual championships</li>
                      </ul>
                    </div>
                    <div>
                      <h4 className="font-semibold text-[#002147] mb-2">Girls Wrestling</h4>
                      <ul className="text-sm space-y-1 text-[#002147]/80">
            ...
            <Card className="border-2 border-[#002147]/20">
              <CardHeader>
                <CardTitle className="text-[#002147] text-lg">Qualification Summary Table</CardTitle>
              </CardHeader>
              <CardContent className="p-4">
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-slate-200">
                        <th className="text-left p-2 font-semibold text-[#002147]">Classification</th>
                        <th className="text-left p-2 font-semibold text-[#002147]"># Regionals</th>
                        <th className="text-left p-2 font-semibold text-[#002147]">Advancers per Regional</th>
                        <th className="text-left p-2 font-semibold text-[#002147]">Total State Qualifiers</th>
                        <th className="text-left p-2 font-semibold text-[#002147]">Boys Format</th>
                        <th className="text-left p-2 font-semibold text-[#002147]">Girls Format</th>
                      </tr>
                    </thead>
                    <tbody>
                ...
                <div className="mt-4 p-3 bg-[#002147]/5 rounded border border-[#002147]/20">
                  <p className="text-[#002147] text-sm">
          ...
          <CardContent className="p-6">
            <div className="space-y-6">
              <div className="bg-gradient-to-r from-[#CBAF5D]/10 to-[#CBAF5D]/10 p-4 rounded-lg border border-[#CBAF5D]/30">
                <h3 className="font-semibold text-[#002147] mb-2">About the Award</h3>
                <p className="text-[#002147] text-sm leading-relaxed">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="bg-[#CBAF5D]/10 p-3 rounded border border-[#CBAF5D]/30">
                      <div className="font-semibold text-[#002147] text-sm">Award History</div>
                      <div className="text-[#002147]/70 text-xs">Presented annually since 1958</div>
                    </div>
                    <div className="bg-[#002147]/5 p-3 rounded border border-[#002147]/20">
                      <div className="font-semibold text-[#002147] text-sm">Era Changes</div>
                      <div className="text-[#002147]/70 text-xs">
                        Open era (1958-1986) → Divisional era (1987-present)
                      </div>
                    </div>
                    <div className="bg-slate-100 p-3 rounded border border-slate-200">
                      <div className="font-semibold text-[#002147] text-sm">Legacy</div>
              ...
              <div className="bg-gradient-to-r from-[#002147]/5 to-[#001a38]/5 p-4 rounded-lg border border-[#002147]/20">
                <h4 className="font-semibold text-[#002147] mb-2">Find Award Winners</h4>
                <p className="text-[#002147] text-sm mb-3">
