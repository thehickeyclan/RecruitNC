...
export async function POST() {
  try {
    ...
    const standardMappings = [
      ...
      { entity_name: "NC State", entity_type: "college", logo_url: "/wolfpack-logo.png" },
      { entity_name: "North Carolina State", entity_type: "college", logo_url: "/wolfpack-logo.png" },
      { entity_name: "North Carolina State University", entity_type: "college", logo_url: "/wolfpack-logo.png" },
