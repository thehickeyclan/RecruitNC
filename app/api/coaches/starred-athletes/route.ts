    ...
    const result = stars
      .map((star) => {
        ...
        return {
          ...
          graduation_year: star.override_graduation_year ?? athlete.graduation_year ?? athlete.graduationyear,
          weightclass: star.override_weight ?? athlete.weightclass,
          highschool: star.override_highschool ?? athlete.highschool,
          ...
          location: star.override_location ?? athlete.location,
          pipeline_stage: star.pipeline_stage || "Prospect",
          last_contacted: star.last_contacted,
          star_id: star.id,
          athlete_email: star.override_email ?? athlete.contactEmail ?? star.athlete_email,
          athlete_cell: star.override_phone ?? athlete.phone ?? star.athlete_cell,
          ...
          academic_gpa: star.override_gpa ?? athlete.academic_gpa,
          academic_sat: star.override_sat ?? athlete.academic_sat,
          academic_act: star.override_act ?? athlete.academic_act,
