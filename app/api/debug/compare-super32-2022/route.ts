/**
 * Compare Super 32 2022: CSV file (scripts/super32-nc-records-2022.csv) vs super32_results table.
 * GET returns a diff report: onlyInCsv, onlyInDb, matched, fieldDifferences.
 * Use for understanding gaps before aligning the database to the authoritative list.
 */
...
const CSV_PATH = join(process.cwd(), "scripts", "super32-nc-records-2022.csv")
const YEAR = 2022
...
export async function GET() {
  try {
    ...
    console.error("[compare-super32-2022]", err)
    return NextResponse.json(
