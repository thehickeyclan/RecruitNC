/**
 * Compare Super 32 2023: CSV file (scripts/super32-nc-records-2023.csv) vs super32_results table.
...
const CSV_PATH = join(process.cwd(), "scripts", "super32-nc-records-2023.csv")
const YEAR = 2023
...
export async function GET() {
  try {
    ...
    console.error("[compare-super32-2023]", err)
    return NextResponse.json(
