/**
 * Compare Super 32 2025: CSV file (scripts/super32-nc-records-2025.csv) vs super32_results table.
...
const CSV_PATH = join(process.cwd(), "scripts", "super32-nc-records-2025.csv")
const YEAR = 2025
...
export async function GET() {
  try {
    ...
    console.error("[compare-super32-2025]", err)
    return NextResponse.json(
