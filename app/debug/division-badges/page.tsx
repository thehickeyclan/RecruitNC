...
export default function DivisionBadgesDebugPage() {
  ...
  return (
    <div className="container mx-auto p-8">
      <h1 className="text-2xl font-bold mb-6">Division Badges Debug</h1>
