  ...
  return (
    <section className="border-b border-white/[0.06] bg-[#0F2D5A] px-4 py-16 sm:py-20">
      <div className="mx-auto max-w-3xl text-center sm:text-left">
        ...
        <p className="mt-6 font-semibold text-white/90">What&apos;s inside:</p>
        <ul className="mt-3 space-y-2 text-left text-sm leading-relaxed text-white/72">
          {BULLETS.map((b) => (
        ...
        <p className="mt-6 text-sm text-white/60">Sign up free to access the full playbook.</p>
        <HardLink
