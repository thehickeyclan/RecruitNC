...
/** Fundraising links + future leaderboard; gifts attributed via Stripe metadata athlete_code. */
      ...
      <div className="mx-auto max-w-6xl px-4">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-[#999]">
            ...
            gives. Kids who aren&apos;t on the course can still fundraise: share the link or enter the same{" "}
            <strong className="text-[#ccc]">fundraising code</strong> on the donation form (it&apos;s not a store promo
            code; it&apos;s how we attribute dollars in our systems).
          </p>
        </div>
        ...
        <div className="mx-auto mt-10 max-w-xl rounded border border-[#333] bg-[#141414] p-6 text-left">
          <p className="text-sm text-[#bbb]">
            ...
            campaign URL (grad year as two digits). Example:{" "}
            <HardLink
          ...
          <p className="mt-4 text-xs text-[#666]">
            ...
            fundraising code — see <strong className="text-[#888]">Admin → Fundraising → Spartan 2026</strong>.
          </p>
        </div>
      </div>
    </section>
