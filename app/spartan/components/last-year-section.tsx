    ...
    <section className="border-b border-[#2A2A2A] bg-[#0A0A0A] py-14 md:py-20">
      <div className="mx-auto max-w-4xl px-4">
        ...
        <p className="mx-auto mt-3 max-w-xl text-center text-sm text-[#888]">
          NC United athletes on course — we&apos;re back in Fayetteville Spartan weekend May 2–3; many on the Super 10K
          Sunday, May 3, with other distances on course too. Same mission: fund the next season of training and competition.
        </p>
