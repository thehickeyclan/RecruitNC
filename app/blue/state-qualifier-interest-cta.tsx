...
export function StateQualifierInterestCTA() {
  ...
  return (
    <button
      onClick={handleClick}
      className="inline-flex items-center justify-center rounded-md bg-[#03154C] px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-[#0a2571] focus-visible:outline focus-visible:ring-2 focus-visible:ring-[#D3B574] focus-visible:ring-offset-2"
    >
